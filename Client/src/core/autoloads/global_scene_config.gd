...
var scene_menus = {
	"options_menu": "res://src/ui/menus/main_menu/options_menu/options_menu.tscn",
	"main_menu": "res://src/ui/menus/main_menu/main_menu.tscn",
	"connection_menu": "res://src/ui/menus/main_menu/connection_menu/connection_menu.tscn",
	"login_menu": "res://src/ui/menus/main_menu/connection_menu/login_menu/login_menu.tscn",
	"character_menu": "res://src/ui/menus/main_menu/connection_menu/login_menu/character_menu/character_menu.tscn",
}

var misc_scenes = {
	"menu_scene": "res://src/system/start_scene/menu_scene.tscn",
	"client_main": "res://src/core/client_main.tscn",
...
var scene_cores = {
	...
	"network_manager": "res://src/core/network/network_manager.tscn",
}
...
func get_scene_path(scene_name: String) -> String:
	...
	if scene_menus.has(scene_name):
		return scene_menus[scene_name]
