	...
	if dir != null:
		...
		while file_name != "":
			if dir.current_is_dir() and file_name != "." and file_name != "..":
				...
				# Rufe die Szenen im Unterverzeichnis ab
				var sub_scenes = get_scene_paths(directory + "/" + file_name, category)

				# Füge die gefundenen Szenen zu `scenes` hinzu
