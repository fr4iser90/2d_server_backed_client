...
@onready var instance_change_exit_area_2d_to_spawn_2 = $"."
@onready var static_body_2d = $StaticBody2D
@onready var barrier_collision_shape_2d = $StaticBody2D/BarrierCollisionShape2D
...
func _on_mouse_entered():
	...
	sprite_2d.modulate = Color(0.5, 0.5, 0.5)  # Darken the area

# Function to handle mouse exiting the area
func _on_mouse_exited():
	print("Mouse exited the area.")
	sprite_2d.modulate = Color(1, 1, 1)  # Reset color
