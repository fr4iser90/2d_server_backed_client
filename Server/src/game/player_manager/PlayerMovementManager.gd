...
func initialize():
	...
	instance_manager = GlobalManager.NodeManager.get_cached_node("game_manager", "instance_manager")
	is_initialized = true
...
func sync_positions_with_clients_in_instance(instance_id: String):
	...
	var instance_manager = GlobalManager.NodeManager.get_node_from_config("game_manager", "instance_manager")
