...
func _reference_nodes():
	...
	GlobalManager.NodeManager.reference_map_entry("BackendManagerMap", "backend_manager", managers)
	GlobalManager.NodeManager.reference_map_entry("AuthManagerMap", "network_meta_manager", managers)
