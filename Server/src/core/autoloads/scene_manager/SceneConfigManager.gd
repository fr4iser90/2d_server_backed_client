...
var scene_cores = {
	"network_server_backend_manager": "res://src/core/server/scenes/network_server_backend_manager.tscn",
	"network_server_client_manager": "res://src/core/server/scenes/network_server_client_manager.tscn",
	"core_tree": "res://src/core/server/scenes/core_tree.tscn",
	"server_console": "res://src/core/server/scenes/server_console.tscn",
}
