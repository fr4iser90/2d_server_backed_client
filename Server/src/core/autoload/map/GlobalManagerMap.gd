...
var scene_manager = {
	...
	"scene_scanner": {"name": "SceneScanner", "path_file": "res://src/core/autoload/scene_manager/scene_scanner/SceneScanner.gd", "path_tree": "/root/GlobalManager/SceneManager/SceneScanner", "cache": true},
	"scene_node_scanner": {"name": "SceneNodeScanner", "path_file": "res://src/core/autoload/scene_manager/scene_scanner/SceneNodeScanner.gd", "path_tree": "/root/GlobalManager/SceneManager/SceneNodeScanner", "cache": true},
	"scene_spawn_point_scanner": {"name": "SceneSpawnPointScanner", "path_file": "res://src/core/autoload/scene_manager/scene_scanner/SceneSpawnPointScanner.gd", "path_tree": "/root/GlobalManager/SceneManager/SceneSpawnPointScanner", "cache": true},
	"scene_trigger_scanner": {"name": "SceneTriggerScanner", "path_file": "res://src/core/autoload/scene_manager/scene_scanner/SceneTriggerScanner.gd", "path_tree": "/root/GlobalManager/SceneManager/SceneTriggerScanner", "cache": true},
}
...
var node_manager = {
	...
	"node_categorization_manager": {"name": "NodeCategorizationManager", "path_file": "res://src/core/autoload/node_manager/NodeCategorizationManager.gd", "path_tree": "/root/GlobalManager/NodeManager/NodeCategorizationManager", "cache": true},
