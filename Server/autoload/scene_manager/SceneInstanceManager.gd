...
func initialize():
	if is_initialized:
		return
	scene_cache_manager = GlobalManager.NodeManager.get_cached_node("global_scene_manager", "scene_cache_manager")
	scene_load_manager = GlobalManager.NodeManager.get_cached_node("global_scene_manager", "scene_load_manager")
	is_initialized = true
...
func create_scene_instance(scene_name: String, instance_key: String) -> Node:
	...
	if scene_instance == null:
		...
		var scene_loader = GlobalManager.NodeManager.get_cached_node("scene_loader")
