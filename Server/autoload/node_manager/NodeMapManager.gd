...
# Load the map files
var categorized_runtime_node_map = "res://autoload/map/CategorizedRuntimeNodeMap.gd"
var global_manager_map = preload("res://autoload/map/GlobalManagerMap.gd").new()
var core_map = preload("res://autoload/map/CoreMap.gd").new()
var user_map = preload("res://autoload/map/UserMap.gd").new()
var game_map  = preload("res://autoload/map/GameMap.gd").new()
var network_database_map = preload("res://autoload/map/NetworkDatabaseMap.gd").new()
var network_game_map = preload("res://autoload/map/NetworkGameMap.gd").new()
